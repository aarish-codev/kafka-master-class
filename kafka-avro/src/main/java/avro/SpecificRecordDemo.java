...
//
//    private static final String PATHNAME = "kafka-avro/src/main/resources/avro/customer-generic.avro";
//
...
//            dataFileWriter.create(customer.getSchema(), new File(PATHNAME));
...
//        final File fileGeneric = new File(PATHNAME);
